  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "float-drift": "float-drift var(--drift-duration, 12s) linear infinite",
        shimmer: "shimmer 3s ease-in-out infinite",
        "wave-horizontal": "wave-horizontal 10s linear infinite",
        "pulse-soft": "pulse-soft 4s ease-in-out infinite",
        "staircase-in": "staircase-in 0.6s ease-out forwards",
      },
    },
  },
